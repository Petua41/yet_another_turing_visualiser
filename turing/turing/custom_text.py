...
'''
Код ниже я взял с сайта <https://itecnote.com/tecnote/python-how-to-highlight-text-in-a-tkinter-text-widget/>.
Автор там не указан, поэтому в этом файле не будет копирайта.
'''
